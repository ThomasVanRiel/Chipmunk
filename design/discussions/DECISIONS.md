...
| Frontend | Deferred indefinitely. See `design/tasks/backlog.md`. | `design/docs/05-frontend-design.md` |
...
| Setup grouping | Operations grouped under setups. Setup defines WCS, stock, clearance height. Operations inherit with per-operation override. | `design/discussions/api.md` #2.6, `design/docs/02-api-design.md` |
...
| Simulation API contracts | Defined in `02-api-design.md` as future placeholders (deferred) | `design/discussions/api.md` #2.8 |
